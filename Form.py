...
def validations():
    ...
    elif age.get() == "" or age.get()<18:
        messagebox.showinfo("Alert", "age must be above 18")
    elif gender.get() == 0:
...
#validate_age = win.register(checkage)  # validation register
#entry_age.config(validate="key", validatecommand=(validate_age, "%P"))
